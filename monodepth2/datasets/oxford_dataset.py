...
from .mono_night_dataset import MonoNightDataset
from PIL import Image

class OxfordDataset(MonoNightDataset):
...
class OxfordNightDataset(OxfordDataset):
    """KITTI dataset which loads the original velodyne depth maps for ground truth
    """
    def __init__(self, *args, **kwargs):
        super(OxfordNightDataset, self).__init__(*args, **kwargs)
